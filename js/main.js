...
function changeUI(verdict, gameRecommended, age) {
...
var game1 = new Game("OverWatch", "./img/overwatchsc.jpg");
var game2 = new Game("League of Legends", "./img/lolsc.jpg");
var game3 = new Game("Pokemon' GO!", "./img/pokemonsc.jpg");
var game4 = new Game("DOTA 2", "./img/dota2sc.jpg");
var game5 = new Game("Blade and Soul", "./img/bssc.jpg");
var game6 = new Game("Lost Ark", "./img/lostarksc.jpg");
var game7 = new Game("Star Wars BATTLEFRONT", "./img/swsc.jpg");
/* Game recommended for higher age band */
var game8 = new Game("DOOM 4K", "./img/doom4ksc.jpg");
var game9 = new Game("SuperHot", "./img/superhotsc.jpg");
var game10 = new Game("Dishonored 2", "./img/dhsc.jpg");
var game11 = new Game("Alien Isolation", "./img/aliensc.jpg");
